...
## Notes
 bash scripts/cleanAndBuildPackages.sh
 docker-compose -f docker-compose-wf.yml build
 docker-compose -f docker-compose-wf.yml up
 docker-compose -f docker-compose-wf.yml down
